 ...
 * 
 */
@WebServiceClient(name = "OrderServiceService", targetNamespace = "http://orderWeb/", wsdlLocation = "http://localhost:8888/orders?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICESERVICE_QNAME = new QName("http://orderWeb/", "OrderServiceService");
    ...
    public OrderService getOrderServicePort() {
        return super.getPort(new QName("http://orderWeb/", "OrderServicePort"), OrderService.class);
    }
    ...
    public OrderService getOrderServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://orderWeb/", "OrderServicePort"), OrderService.class, features);
    }
